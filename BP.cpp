...
// constructor
BP_Op::BP_Op(int maxdeg, Z2_Op *Z2_op, matrix<BP> *etaL_mat, matrix<BPBP> *delta_mat, matrix<BP> *R2L_mat) : ModuleOp<exponent, Z2>(Z2_op), PolynomialOp_Para<Z2>(Z2_op), BPBP_opers(this), BPBPBP_opers(&BPBP_opers), BPMod_opers(this), BPBPMod_opers(&BPBP_opers), Z2Mod_opers(Z2_op), mon_index(maxdeg)
{
